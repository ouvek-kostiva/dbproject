  ...
  <body>
    ...
    <nav class="navbar">
      <ul class="nav nav-tabs">
        ...
        <li role="presentation"><a href="./Sales_Order_Add.php">訂單</a></li>
        <li role="presentation" class="active"><a>出貨</a></li>
        ...
        <div class="col-lg-3">
          <a href="./Delivery_Search.php" class="btn btn-primary btn-sm">
    ...
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="col-lg-3">
          <div class="input-group">
            <span class="input-group-addon">出貨備註</span>
