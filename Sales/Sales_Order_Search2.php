...
<form class="form-horizontal" role="form" method="post" action="./Sales_Order_Update2.php">
 ...
 echo "<tr><td><input type='checkbox'  name='SOid' value=".$row['SO_List_SalesOrder_id'].">".$row['SO_List_SalesOrder_id']."</td>";     //儲存SalesOrder_List資料表欄位
  echo '<td>'.$row['SO_Product_id'].'</td>';
  echo '<td>'.$row['SO_List_Quantity'].'</td>';
  echo '<td>'.$row['SO_List_UnitPrice'].'</td>';
  echo '<td>'.$row['SO_List_Discount'].'</td>';
  echo '<td>'.$row['SO_List_Tax'].'</td>';
  echo '<td>'.$row['SO_List_Remarks'].'</td>';
  echo '<td><a href=./Sales_Order_Update2.php><span class="glyphicon glyphicon-pencil" aria-hidden="true"></span></a></td>'; //修改按鈕
...
<!-- Haven't changed below for javascript end  -->
 ...
 <form class="form-horizontal" role="form" method="post" action="./Delivery_Add1.php">
