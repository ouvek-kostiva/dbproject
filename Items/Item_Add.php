...
if(isset($_POST['save'])){
    ...
    if($has_needed){ //檢查是否有完成必填
        ...
        if($PcodeExist > 0){ //Productcode已存在 (更新)
            ...
            if($update->rowCount() > 0){
                echo "</br></br><div class='alert alert-success' role='alert'> 成功更新 $Productcode 資料 </div>";
            }else{
                echo "</br></br><div class='alert alert-warning' role='alert'> 更新有問題 </div>";
            }
            ...
            if($insert->rowCount() > 0){
                echo "</br></br><div class='alert alert-success' role='alert'> 成功新增 $Productcode 資料 </div>";
            }else{
                echo "</br></br><div class='alert alert-warning' role='alert'> 新增有問題 </div>";
            }
        }
    ...
    if($PcodeExist > 0){
        $update = $conn->prepare("UPDATE Products SET
            ...
            if($update->rowCount() > 0){
                echo "</br></br><div class='alert alert-success' role='alert'> 成功刪除 $Productcode 資料 </div>";
            }else{
                echo "</br></br><div class='alert alert-warning' role='alert'> 刪除有問題 </div>";
            }
    }else{
      ...
      <div class="row">
        <div class="col-lg-3">
          <div class="input-group">
            ...
            <input type="text" class="form-control" placeholder="Productcode" name="Productcode" value="<?php if($SearchExist > 0){echo $search['Productcode']; } ?>">
          </div><!-- /input-group -->
        </div><!-- /.col-lg-6 -->
        <div class="col-lg-3">
          <div class="input-group">
            <span class="input-group-addon">物品條碼</span>
            <input type="text" class="form-control" placeholder="Product_Barcode" name="Product_Barcode" value="<?php if($SearchExist > 0){echo $search['Product_Barcode']; } ?>">
          </div><!-- /input-group -->
        </div><!-- /.col-lg-6 -->
        <div class="col-lg-3">
          <div class="input-group">
            <span class="input-group-addon">物品名稱*</span>
            <input type="text" class="form-control" placeholder="Productname" name="Productname" value="<?php if($SearchExist > 0){echo $search['Productname']; } ?>">
          </div><!-- /input-group -->
        </div><!-- /.col-lg-6 -->
        <div class="col-lg-3">
          <div class="input-group">
            <span class="input-group-addon">物品異名</span>
            <input type="text" class="form-control" placeholder="Productname2" name="Productname2" value="<?php if($SearchExist > 0){echo $search['Productname2']; } ?>">
          </div><!-- /input-group -->
        </div><!-- /.col-lg-6 -->
      </div><!-- /.row -->
      ...
      <div class="row">
        <div class="col-lg-2">
          <div class="input-group">
            ...
            <input type="text" class="form-control" placeholder="Unit" name="Unit" value="<?php if($SearchExist > 0){echo $search['Unit']; } ?>">
          </div><!-- /input-group -->
        </div><!-- /.col-lg-6 -->
        <div class="col-lg-7">
          <div class="input-group">
            <span class="input-group-addon">備註</span>
            <input type="text" class="form-control" placeholder="Product_Remarks" name="Product_Remarks" value="<?php if($SearchExist > 0){echo $search['Product_Remarks']; } ?>">
          </div><!-- /input-group-->
        </div><!-- /.col-lg-6 -->
        <div class="col-lg-3">
          <div class="input-group">
            <span class="input-group-addon">數量</span>
            <input type="text" class="form-control" placeholder="Product_Qty" name="Product_Qty" value="<?php if($SearchExist > 0){echo $search['Product_Qty']; } ?>">
          </div><!-- /input-group -->
        </div><!-- /.col-lg-6 -->
      </div><!-- /.row -->
