...
try {
    ...
    $search1 = $db->query("SELECT * FROM Receive WHERE Receive_id='$Receive_id'");
    $search2 = $db->query("SELECT * FROM Receive_List WHERE Receive_List_Receive_id='$Receive_id'");
  ...
  <body>
    ...
    <nav class="navbar">
      <ul class="nav nav-tabs">
        ...
        <div class="col-lg-3">
          <a href="./Receive_Search.php" class="btn btn-primary btn-sm">
    ...
    <form method="POST" action="Receive_Updata2.php">
    <div class="container">
      ...
      <div class="row">
        <div class="col-lg-3">
          <div class="input-group">
            ...
            <input type="text" class="form-control" placeholder="Receive ID" name="Receivecode" value="<?php echo $row['Receivecode'] ?>">
          </div><!-- /input-group -->
        </div><!-- /.col-lg-6 -->
        <div class="col-lg-3">
          <div class="input-group">
            <span class="input-group-addon">入庫日期</span>
            <input type="text" class="form-control" placeholder="2016/01/01" name="Receive_Date" value="<?php echo $row['Receive_Date'] ?>">
          </div><!-- /input-group -->
        </div><!-- /.col-lg-6 -->
        <div class="col-lg-6">
          <div class="input-group">
            <span class="input-group-addon">備註</span>
            <input type="text" class="form-control" placeholder="資訊" name="Receive_Remarks" value="<?php echo $row['Receive_Remarks'] ?>">
          </div><!-- /input-group -->
        </div><!-- /.col-lg-6 -->
      </div><!-- /.row -->
      <?php } ?>
      ...
      <table class="table">
        ...
        ?>
          <tr>
            <td><?php $n ?></td>
            <td><input type="text" class="form-control" placeholder="00001" name="Product_id[]" value="<?php echo $row2['Receive_List_Product_id'] ?>"></td>
            <td><input type="text" class="form-control" placeholder="胡椒鹽" ></td>
            <td><input type="text" class="form-control" placeholder="2" name="Qty[]" value="<?php echo $row2['Receive_List_Quantity'] ?>"></td>
            <td><input type="text" class="form-control" placeholder="KG"></td>
            <td><input type="text" class="form-control" placeholder="" name="Price[]" value="<?php echo $row2['Receive_List_UnitPrice'] ?>"></td>
            <td><input type="text" class="form-control" placeholder="" name="Remarks[]" value="<?php echo $row2['Receive_List_Remarks'] ?>"></td>
          </tr>
        <?php } ?>
        </tbody>
      </table>
